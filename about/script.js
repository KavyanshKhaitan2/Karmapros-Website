// IF YOU WANT TO PUT 1 BACKSLASH IN ABOUT DESCRIPTION YOU WILL HAVE TO PUT 2 BACKSLASHES
about_description =/* Put yor about description \/ the next line */ `
Unschooled farm boy that plays a lot of minecraft
`
...
setTimeout(() => {
  aboutUpdatedDescription = about_description.replaceAll("\n", "<br>")
  document.getElementById("about_desc").innerHTML = aboutUpdatedDescription;
}, 500);